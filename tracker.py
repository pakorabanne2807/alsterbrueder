...
def render_html5_taktikboard():
    ...
    <script>
        ...
        drawCanvas.addEventListener('touchstart', (e) => {
            e.preventDefault(); // Stoppt Seiten-Scrollen sofort
            ...
            // 3. Linien (Pass / Laufweg) direkt mit dem Finger aufziehen
        ...
        drawCanvas.addEventListener('touchend', (e) => {
            ...
            if (isDragging) {
                ...
                isLineDrawing = false;
                saveSnapshot();
                // Wir nehmen die letzte Touch-Position oder behalten die Linie bei
                let changed = false;
                if (shapes.length > 0) {
                    // Letzte gezeichnete Linie fixieren
                }
                redrawAll();
            }
        }, { passive: false });
